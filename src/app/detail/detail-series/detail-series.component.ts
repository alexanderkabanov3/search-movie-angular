...
export class DetailSeriesComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.router.params.subscribe((params: Params) => {
      ...
      this.getCredits(this.id).then((data: any) => {
        this.cast = data.cast;
      });

      this.getSimilar(this.id).then((data: any) => {
  ...
  leaveComment(): void {
    ...
    this.postComment
      .post(
        `https://search-movie-server.herokuapp.com/api/comments/seriesoverview/${this.id}`,
        comObj,
        {
          headers: header,
        }
  ...
  deleteComment(event: number): void {
    ...
    this.deleteCommentHttp
      .delete(
        `https://search-movie-server.herokuapp.com/api/comments/seriesoverview/${this.id}/${event}`,
        {
          headers: header,
        }
      )
